...
## 2. 선수 조건
- lecture36 완료 또는 동등한 실무 경험
- Linux 기본 명령어(ls, cat, systemctl) 사용 가능

## 3. 학습 목표
- Ingress와 외부 트래픽 라우팅 주제를 Ansible 중심으로 설명할 수 있다.
